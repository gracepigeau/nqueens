...
def readInFile():
        ...
        with open('nqueens.txt', 'r') as file:
                # Instantiate an empty array and for each line in the file...
                dimensionArray = []
                for line in file:
                        # ...Convert the string to an int and store it in the list
        ...
        # Return resulting array of test n dimensions
        return dimensionArray


# Append the solution array to the output file
def writeToFile():
        # Add one to each index, because our algorithm uses 0-based indexing
        solutionArrayStr = str([x + 1 for x in board])

        # Open and write to file with a buffer of 64
...
def createBoard():
        ...
        # Iterate through the dimension of the board
        ...
        # Iterate through the unplaced columns
        for col in notPlaced:
                # And place the remaining queen locations
...
def findMaxConflictCol():
        ...
        # Iterate though every column on the board
        for col in range(0,DIM):
...
def solveNQueens():
        createBoard()
        # Initialized to track iterations of nqueens
        iteration = 0
        # Define the maximum iterations as 0.6*size of board
        ...
        while (iteration < maxIteration):
                ...
                #       equals 3, then there are no conflicts since the queen is alone in it's row and both diagonals
                        ...
                        # Return True because the solution found
                        return True
                iteration += 1
...
def main():
        ...
        # For each test dimension value provided
